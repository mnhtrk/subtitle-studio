    ...
    for raw_line in sys.stdin:
        ...
        if cmd == "detect":
            ...
            if not path:
                ...
                continue
            try:
                speech_pad_ms = int(req.get("speech_pad_ms", 200))
                min_silence_duration_ms = int(req.get("min_silence_duration_ms", 900))
                min_speech_duration_ms = int(req.get("min_speech_duration_ms", 300))
